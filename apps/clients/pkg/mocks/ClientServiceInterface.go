...
func (_m *ClientServiceInterface) CreateClientByName(ctx context.Context, req *model.CreateClientByNameReq) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, *model.CreateClientByNameReq) error); ok {
		r0 = rf(ctx, req)
	} else {
		r0 = ret.Error(0)
	}
...
// UpdateClient provides a mock function with given fields: ctx, clientID, data
func (_m *ClientServiceInterface) UpdateClient(ctx context.Context, clientID string, data bson.D) error {
